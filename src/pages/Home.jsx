...
export default function Home() {
  return (
    <>
      ...
      <div className="flex gap-10 items-center justify-between bg-blue-200  flex-row md:w-3/4 mx-auto mt-20 mb-20">
      <div className="bg-blue-200  w-full h-[20rem] bg-cover bg-img3">
       {/* <img className="w-3/4 h-full bg-contain  px-5" src= {picture}  ></img> */}
      </div>
